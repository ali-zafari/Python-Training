...
def calculate_averages(input_file_name, output_file_name):
    with open(input_file_name, newline='') as fRead:
        ...
        averages = {}
        for row in reader:
            averages[row[0]] = float(mean(map(float, row[1:])))
...
calculate_sorted_averages('scores.csv', 'sorted_averages.csv')
calculate_three_best('scores.csv', 'three_best.csv')
calculate_three_worst('scores.csv', 'three_worst.csv')
calculate_average_of_averages('scores.csv', 'average_of_averages.csv')